            ...
            <footer>
                <div class="top">
                    <div class="pages">
                        ...
                        <ul>
                            <h3>Contact Us</h3>
                            <li><EmailIcon /> casadesilver03@gmail.com</li>
                            <li><WhatsAppIcon /> WhatsApp : +91 7768035252</li>
                            <li><EditLocationAltIcon /> Aundh-Ravet Brt Road Near Dange Chowk Behind Silver Fitness Club,</li>
                            <li>Tathawade, Pune - 411033</li>
                        </ul>
                    </div>
                </div>
                <div class="social">
                ...
                <div class="info">
                    <div class="legal">
                        <p>Terms & ConditionsPrivacy Policy</p>
                    </div>
